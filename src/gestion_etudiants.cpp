...
void ajouter_etudiant(vector<etudiant*>& liste) {
    ...
    cout << "Entrez le Nom (max 49 caractères): ";
...
void menu_principal(vector<etudiant*>& liste) {
    ...
    do {
        ...
        switch (choix) {
            case 1: ajouter_etudiant(liste); break;
            case 2: lister_etudiants(liste); break;
            case 3: supprimer_etudiant(liste); break;
            case 4: supprimer_tous_les_etudiants(liste); break;
            case 0: cout << "Au revoir!" << endl; break;
            default: cout << "Choix non reconnu. Veuillez choisir 1, 2 ou 0." << endl; break;
        }
    } while (choix != 0);
}
